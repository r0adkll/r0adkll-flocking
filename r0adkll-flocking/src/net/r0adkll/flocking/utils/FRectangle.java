...
public class FRectangle implements Serializable {
	...
	static public final FRectangle tmp = new FRectangle();

	/** Static temporary rectangle. Use with care! Use only when sure other code will not also use this. */
	static public final FRectangle tmp2 = new FRectangle();
	...
	/** @param rectangle the other {@link FRectangle}.
	...
	public boolean overlaps (FRectangle rectangle) {
	...
	public void set (FRectangle rect) {
		this.x = rect.x;
		this.y = rect.y;
	 ...
	 * @param rect the other rectangle */
	public void merge (FRectangle rect) {
